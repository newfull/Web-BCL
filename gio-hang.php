      ...
      <div class="c_container">
        <div class="c_container left-c_container">
          <div class="list-header">
            <span class="list-header-left">Tổng số sản phẩm: <? echo count($cart_details_combo)+count($cart_details); ?> </span>
              ...
              <div class=" checkout-summary">
                <div class="checkout-summary-rows">
                  <div class="checkout-summary-row">
                    <div class="checkout-summary-label">Tạm tính (<? echo count($cart_details_combo)+count($cart_details); ?> sản phẩm)</div>
