<?php
 class ResizeImage {
    //$method: 
    //          force : Hàm này cũng tạo một hình ảnh đúng với kích thước mà bạn chỉ định, nhưng khác là nó không crop hình lại.
    //          max: Hàm này sẽ tạo ra một hình với hình ảnh được thu nhỏ không vượt quá các kích thước mà bạn chỉ định.
    //          crop: Hàm này sẽ giúp chúng ta tạo ra một hình ảnh mới với đúng kích thước mà chúng ta chỉ định trong các tham số.
