	<footer id="footer"><!--Footer-->
			...
			<div class="container">
				<div class="row no-gutter">
					...
					<div class="col-xs-2 thuc-don-2">
						...
						<img class="img-responsive pack-demo" src="/images/pack.png"/>
					</div>
					...
					<div class="col-xs-3 text-center nhan-email">
						<h3>Công ty</h3>
						<ul class="list-unstyled">
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<div class="copyright">
						©2018 Gà Rán BCL  All Rights Reserved
					</div>
